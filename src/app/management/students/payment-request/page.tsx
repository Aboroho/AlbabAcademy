  ...
  return (
    <div className="bg-white rounded-md p-4">
      ...
      <div className="max-w-[1536px] overflow-x-auto ">
        <div className="w-[1836px] h-[70vh] overflow-hidden">
          <div className="grid grid-cols-11 text-center font-semibold pb-2 border-b px-6">
                ...
                return (
                  ...
                  >
                    <AccordionTrigger>
                      <div
                        key={pr.id}
                        className="grid grid-cols-11 py-4  px-2 hover:bg-slate-200 cursor-pointer rounded-md text-center border-b border-gray-300"
                      >
                        <div className="text-left">
                          {pr.user.student?.full_name}
                        </div>
                        ...
                        <div className="text-center">
                          {pr.user.student?.roll}
                        </div>
                        <div className="">{pr.payment_request.title}</div>
